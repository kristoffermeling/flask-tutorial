...
def register():
    ...
    if form.validate_on_submit():
        ...
        flash(f"Your account have been created, you can now log in", 'success')
...
def send_reset_email(user):
    ...
    If you did not make this request, then simply ignore this email, then no changes will be made!    
    '''
    mail.send(msg)
